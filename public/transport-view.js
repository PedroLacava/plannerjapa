(function () {
  ...
  var LEGS = [
    ...
    ["18/11", "Tokyo", "Tsukiji", "Metro Marunouchi + Hibiya", "Tokyo Metro", 180, "no", "Ginza Capital Hotel Moegi"],

    ["19/11", "Tsukiji", "Hibiya", "Hibiya Line", "Tokyo Metro", 180, "no", "Palácio Imperial"],
    ["19/11", "Nihombashi", "Tsukiji", "Ginza + Hibiya Line", "Tokyo Metro", 180, "no", "Retorno ao hotel"],
    ["20/11", "Ginza Capital Hotel Moegi", "Mercado Externo de Tsukiji", "Caminhada", "A pé", 0, "no", "Começar perto do hotel"],
    ["20/11", "Hamarikyu", "Shimbashi", "Caminhada", "A pé", 0, "no", "Conexão para teamLab"],
    ...
    ["20/11", "Toyosu", "Tsukiji", "Ônibus ou metrô", "Toei/Metro", 210, "no", "Retorno ao hotel"],
    ["21/11", "Tsukiji", "Meiji-jingumae", "Hibiya + Chiyoda Line", "Tokyo Metro", 210, "no", "Meiji Jingu, Harajuku e Shibuya"],
    ["21/11", "Shibuya", "Shintomicho", "Hanzomon + Yurakucho Line", "Tokyo Metro", 210, "no", "Retorno ao hotel"],
    ["22/11", "Tsukiji", "Asakusa", "Hibiya + Ginza Line", "Tokyo Metro", 210, "no", "Senso-ji"],
    ...
    ["22/11", "Akihabara", "Tsukiji", "Hibiya Line", "Tokyo Metro", 180, "no", "Retorno direto ao hotel"],
    ["23/11", "Tsukiji", "Shinjuku-gyoemmae", "Hibiya + Marunouchi Line", "Tokyo Metro", 210, "no", "Shinjuku"],
    ["23/11", "Shinjuku-sanchome", "Tsukiji", "Marunouchi + Hibiya Line", "Tokyo Metro", 210, "no", "Retorno"],
    ["24/11", "Shintomicho", "Ginza-itchome", "Yurakucho Line + caminhada", "Tokyo Metro", 180, "no", "Saída Yaesu de Tokyo Station"],
    ...
    ["24/11", "Tokyo Station", "Ginza Capital Hotel Moegi", "Metrô ou caminhada", "Tokyo Metro", 180, "no", "Retorno ao hotel"],
    ["25/11", "Ginza Capital Hotel Moegi", "Hatchobori", "Caminhada", "A pé", 0, "no", "Cerca de 12 min"],
    ["25/11", "Hatchobori", "Maihama", "JR Keiyo Line", "JR", 230, "yes", "Acesso direto ao Disney Resort"],
    ...
    ["25/11", "Maihama", "Hatchobori", "JR Keiyo Line", "JR", 230, "yes", "Retorno direto"],
    ["25/11", "Hatchobori", "Ginza Capital Hotel Moegi", "Caminhada", "A pé", 0, "no", "Retorno ao hotel"],
    ["26/11", "Tsukiji", "Nakameguro", "Hibiya Line", "Tokyo Metro", 260, "no", "Direto quando houver serviço contínuo"],
    ["26/11", "Ebisu", "Tsukiji", "Hibiya Line", "Tokyo Metro", 210, "no", "Retorno direto ao hotel"],
    ["27/11", "Tsukiji", "Higashi-ginza", "Hibiya Line", "Tokyo Metro", 180, "no", "Com malas; conexão para Asakusa Line"],
    ["27/11", "Higashi-ginza", "Narita Airport", "Access Express", "Keisei/Toei", 1400, "no", "Direto em horários selecionados; confirmar no dia"],
  ];
